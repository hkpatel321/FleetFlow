    ...
    return (
        <div
            style={{
                ...
                bottom: bottom,
                opacity: opacity,
                animation: mounted ? `float ${duration}s ease-in-out ${delay}s infinite` : 'none',
                pointerEvents: "none",
                zIndex: 1
            }}
        />
    ...
    return (
        <div
            style={{
                ...
                animation: mounted && !isHovered ? `float 6s ease-in-out ${delay}s infinite` : 'none'
            }}
